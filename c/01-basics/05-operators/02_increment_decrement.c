...
int main(int argc, char const *argv[]) {
  /*
      ...
      difference:
      - in post operations, first current value is used in the statement, and
     then the increment/ decrement operator is applied
      - in pre operations, first increment/ decrement operator is applied and
     then updated value is used in the statement
  ...
  */
  ...
  /*
      ...
      The C standard states: "Between the previous and next sequence point an
     ...
     determine the value to be stored." To do otherwise results in undefined
